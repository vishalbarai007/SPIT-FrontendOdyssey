    ...
    <div className="absolute bottom-6 left-0 right-0 px-6">
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <span className={`${!isDark && 'group-hover:opacity-100'} ${isDark && 'group-hover:opacity-100'} opacity-0 transition-opacity duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
